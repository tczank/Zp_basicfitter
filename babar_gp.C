...
void babar_gp() {
  ...
  TFile * nobs_file = new TFile("./babar_sum_inv_notnarrow.root");
  ...
  //Output File //
  TFile * f = new TFile("babar_gp_inv_notnarrow.root","RECREATE");
  ...
  TH2I * gp = new TH2I("h_gp_m_gz", "g' coupling strength by mass and g'z;m_{Z'}[GeV/c^{2}];g';", 2219,0.212,9.99923,10000,-5.,0.0);
  //  TGraph * gr_gp[11064];
  // ########################################################## //
