...
void nexp_v0(TString signalfilename) {

  //## Loading the different CMS E "Theoretical" Cross section
...
TGraphErrors *up5sxs = (TGraphErrors*) up1s_xs->Get("Cross_section_Y5S");
  ...
  TFile *bg = new TFile("../cor_signal_mc_isr/newbackaafhmumumumu_corpart.root");
