...
void cball_paropt(TString signalfilename) {
  ...
  if(hist_mean < 0.212){
    ...
    double_crystalball = new TF1("double_crystalball", "crystalball(0) ", hist_mean - 100*peakwidth , hist_mean + 100*peakwidth);
    ...
    double_crystalball->SetParLimits(3,-2,5.);
 ...
 opt_dbcball->SetRange(lowerfit,  higherfit);
  ...
  // here it is ok
    ...
    //cout << tripS << " " << tripSer << " " << B << " " << Ber << " " << intestep << endl;
         ...
         cout << hist_mean << " " << double_crystalball->GetParameter(0) << " " << double_crystalball->GetParError(0) << " " << double_crystalball->GetParameter(1) << " " << double_crystalball->GetParError(1) << " " << double_crystalball->GetParameter(2) << " " << double_crystalball->GetParError(2) << " " << double_crystalball->GetParameter(3) << " " << double_crystalball->GetParError(3) << " " << double_crystalball->GetParameter(4) << " " << double_crystalball->GetParError(5) << endl;
