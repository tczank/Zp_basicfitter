...
void dcball_paropt_2212(TString signalfilename) {
  ...
  if(hist_mean < 0.212){
    ...
    double_crystalball->SetParLimits(0,0.,entriesatmean - 400);
    ...
    double_crystalball->SetParLimits(5,0,entriesatmean - 400);
