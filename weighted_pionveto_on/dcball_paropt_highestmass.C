...
void dcball_paropt_highestmass(TString signalfilename) {
  ...
  if(hist_mean < 0.212){
    ...
    double_crystalball->SetParLimits(0,0.,entriesatmean - 10);
    ...
    double_crystalball->SetParLimits(3,-3,0.);
    double_crystalball->SetParLimits(4,0.,3.);
    double_crystalball->SetParLimits(5,0,entriesatmean - 10);
    double_crystalball->SetParLimits(7,rms,3*peakwidth);
    double_crystalball->SetParLimits(8,0.0,3);
    double_crystalball->SetParLimits(9,1,3);
