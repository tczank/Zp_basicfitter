...
void dcball_paropt_highermass(TString signalfilename) {
  ...
  if(hist_mean < 0.212){
    ...
    double_crystalball->SetParLimits(2,rms,70*peakwidth);
    double_crystalball->SetParLimits(3,-70,0.);
    double_crystalball->SetParLimits(4,0.,50.);
    double_crystalball->SetParLimits(5,0,entriesatmean);
    double_crystalball->SetParLimits(7,rms,70*peakwidth);
    double_crystalball->SetParLimits(8,0.0,70);
