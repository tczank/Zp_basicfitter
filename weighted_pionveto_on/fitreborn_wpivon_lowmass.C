...
void fitreborn_wpivon_lowmass(TString signalfilename) {

  TFile * br_fil = new TFile("/home/tczank/Documentos/merging_energies/Zp_BR.root");
  TFile * genid_isr_w = new TFile("/home/tczank/Documentos/signal_mc_dist_reader/all_4mu_redmu_cor_isr.root");
  ...
  TFile *bg = new TFile("/home/tczank/Documentos/weighted_pion_veto/aafhmumumumu_wpion.root");
