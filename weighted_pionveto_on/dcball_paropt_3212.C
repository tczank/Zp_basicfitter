...
void dcball_paropt_3212(TString signalfilename) {
  ...
  if(hist_mean < 0.212){
    ...
    double_crystalball->SetParLimits(0,0.,entriesatmean + 500);
    double_crystalball->FixParameter(1,hist_mean);
    double_crystalball->FixParameter(6,hist_mean);
    double_crystalball->SetParLimits(2,rms,5*peakwidth);
    double_crystalball->SetParLimits(3,-50,0.);
    double_crystalball->SetParLimits(4,0.,90.);
    double_crystalball->SetParLimits(5,0,entriesatmean + 500);
    double_crystalball->SetParLimits(7,rms,5*peakwidth);
    double_crystalball->SetParLimits(8,0.0,50);
    double_crystalball->SetParLimits(9,1,90);
