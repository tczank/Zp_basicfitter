...
void sigmc_dreader_pvon () {

  TString isr_name[] = {"../../pion_veto_on/darkz_isr_212_all_pvon.root", "../../pion_veto_on/darkz_isr_712_all_pvon.root","../../pion_veto_on/darkz_isr_1212_all_pvon.root","../../pion_veto_on/darkz_isr_1712_all_pvon.root","../../pion_veto_on/darkz_isr_2212_all_pvon.root","../../pion_veto_on/darkz_isr_2712_all_pvon.root","../../pion_veto_on/darkz_isr_3212_all_pvon.root","../../pion_veto_on/darkz_isr_3712_all_pvon.root","../../pion_veto_on/darkz_isr_4212_all_pvon.root","../../pion_veto_on/darkz_isr_4712_all_pvon.root","../../pion_veto_on/darkz_isr_5212_all_pvon.root", "../../pion_veto_on/darkz_isr_5712_all_pvon.root","../../pion_veto_on/darkz_isr_6212_all_pvon.root","../../pion_veto_on/darkz_isr_6712_all_pvon.root","../../pion_veto_on/darkz_isr_7212_all_pvon.root","../../pion_veto_on/darkz_isr_7712_all_pvon.root","../../pion_veto_on/darkz_isr_8212_all_pvon.root","../../pion_veto_on/darkz_isr_8712_all_pvon.root","../../pion_veto_on/darkz_isr_9212_all_pvon.root","../../pion_veto_on/darkz_isr_9712_all_pvon.root","../../pion_veto_on/darkz_isr_10000_all_pvon.root"};
  ...
  gr_det->SetTitle("detection efficiency by its reduced mass with pion veto");
  gr_det->SetName("gr_det_pvon");
  ...
  TFile * dists = new TFile("all_4mu_redmu_cor_isr_pvon.root", "RECREATE");
  gr_w_isr->Write();
  gr_det->Write();
  //  gr_w_isr_4mu->Write();
   ...
   for(int i = 0; i < 21; i++){
     ...
     // redmu_isr[i]->Write();
     redmu_isr_4mu[i]->SetName(TString::Format("redmu_4mu_pvon_%d",i));
