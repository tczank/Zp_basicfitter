...
void rootgen_whizard0_v1() {
  ifstream in;
  in.open(Form("whizard0eff_all.dat"));
  ...
  Int_t nlines = 0;
   TFile *f = new TFile("whizard0eff_all.root","RECREATE");
   ...
   while (1) {
     ...
     if (!in.good()) break;
     if (nlines < 18) printf(" x=%8f, z=%8f, ez=%8f, f1=%8f, ef1=%8f, f2=%8f, ef2=%8f, y=%8f, ey=%8f, o=%8f, xs=%8f, s=%8f \n ",x, z, ez, f1,ef1, f2, ef2, y, ey, o, xs, s);
